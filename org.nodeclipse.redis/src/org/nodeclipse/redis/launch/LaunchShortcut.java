...
/**
 * Using "Run As" --> "mongodb shell JavaScript" will lead here
 **/
public class LaunchShortcut implements ILaunchShortcut {
    ...
    private void launchFile(IFile file, String mode) throws CoreException {
        ...
        ILaunchConfigurationType type = launchManager.getLaunchConfigurationType("org.nodeclipse.mongodb.launch.LaunchConfigurationType"); //Constants."LAUNCH_CONFIGURATION_TYPE_ID"
